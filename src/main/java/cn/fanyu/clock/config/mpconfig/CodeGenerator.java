package cn.fanyu.clock.config.mpconfig;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String DATA_SOURCE_URL = "jdbc:mysql://127.0.0.1:3306/clock?characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false";
        String DATA_SOURCE_DRIVER = "com.mysql.jdbc.Driver";
        String DATA_SOURCE_USERNAME = "root";
        String DATA_SOURCE_PASSWORD = "123";
        String DATA_PACKAGE = "cn.fanyu.clock";
        ...
        //Author设置作者
        globalConfig.setAuthor("DongJin");
        //是否覆盖文件
